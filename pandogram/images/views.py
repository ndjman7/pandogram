...
from pandogram.users import models as user_models, serializers as user_serializers
...
class LikeImage(APIView):
    ...
    def post(self, request, image_id, format=None):
        ...
        try:
            ...
            notification_views.create_notification(creator=user, to=found_image.creator,
                                                   notification_type='like', image=found_image)
    ...
    def post(self, request, image_id, format=None):
        ...
        if serializer.is_valid():
            ...
            notification_views.create_notification(
                creator=user, to=found_image.creator, notification_type='comment', image=found_image,
